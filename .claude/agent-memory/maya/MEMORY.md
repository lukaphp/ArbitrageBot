...
- ["Ignoto" non è zero né verde](feedback_stato-ignoto-non-e-zero.md) — tre stati, non due; anche i `catch` devono dichiarare; invarianti nei test sul markup
...
- [Working tree condiviso con Bruno e Joshua](project_working-tree-condiviso.md) — un rosso può essere di un altro a metà modifica: `git status` prima di sospettarti
