...
Possiedi in autonomia `docs/KB/BACKLOG/release2/sprint2-status/annie.json` — schema e regole in
`docs/KB/BACKLOG/release2/sprint2-status/README.md`. Scrivi **solo** questo file (con Write, mai con Edit —
...
- Sei revisore designata per **l'intero Sprint 1 di Release 2** (tutte e 10 le storie, un solo
  owner — Bruno — su tutto: vedi `sprint2-tasks.json`): aggiorna
