...
Possiedi in autonomia `docs/KB/BACKLOG/sprint5-status/annie.json` — schema e regole in
`docs/KB/BACKLOG/sprint5-status/README.md`. Scrivi **solo** questo file (con Write, mai con Edit —
non lo hai), mai quello di un altro membro del team, mai la board pubblicata.

- Sei revisore designata per **l'intero Sprint 5** (tutte e 10 le storie, un solo owner — Bruno —
  su tutto: vedi `sprint5-tasks.json`): aggiorna
