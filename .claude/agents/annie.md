...
Possiedi in autonomia `docs/KB/BACKLOG/sprint4-status/annie.json` — schema e regole in
`docs/KB/BACKLOG/sprint4-status/README.md`. Scrivi **solo** questo file (con Write, mai con Edit —
non lo hai), mai quello di un altro membro del team, mai la board pubblicata.

- Sei revisore designata per ADV-01, ADV-02, ADV-03 e DEBT-01 (vedi `sprint4-tasks.json`): aggiorna
